 ...
 * @author ACER
 */
public class FromPemasok extends javax.swing.JFrame {
    DatasetPemasok data;

    /**
     * Creates new form FromPemasok
     */
    public FromPemasok() {
        initComponents();
        this.setLocationRelativeTo(null);
        data = new DatasetPemasok();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        data.tambahnama(String.valueOf(txtnamapemasok.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FromPemasok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
